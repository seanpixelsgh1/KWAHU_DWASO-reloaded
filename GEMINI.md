...
- Framework(s): Next.js 15.5, React 19, Tailwind CSS 4, NextAuth, Firebase
- Package manager: npm
- Runtime / deployment target: Node.js / Cloudflare Pages (via wrangler)
...
- Source lives in: `src/`
- Tests live in: `TODO`
- Do not modify: `node_modules/`, `.next/`, `scratch/`
